...
public class ElectricBillPaymentService {
	...
	private static final String FW_FILE_TYPE = "1";
	...
	public void createFixedLengthFile() throws SQLException, IOException {
		...
		// create file
		createFile(FW_FILE_TYPE);

		// get fileheaderData
		getFileHeaderData(FW_FILE_TYPE);
	...
	private void initDAO() throws SQLException {
		...
		electricBillPaymentDAO = new ElectricBillPaymentDAO();
...
//		private void createFile() {
		...
		try {
			...
			fileNameList = electricBillPaymentDAO.getFileName(connection,fileType);
	...
	private void getFileHeaderData(String fileType) throws SQLException {
		log.info("Method: getFileHeaderData()");
		fileHeaderList = electricBillPaymentDAO.getFileHeadderDetails(connection,fileType);
