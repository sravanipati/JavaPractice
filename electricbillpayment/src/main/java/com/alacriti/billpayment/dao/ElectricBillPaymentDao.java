...
public class ElectricBillPaymentDao {
	...
	public List<FileGenerationVo> getFileName(Connection connection) throws SQLException {
		log.info("Method: getFileName()");
		List<FileGenerationVo> fileNameList = new ArrayList<>();
		String query = "select file_prefix,format,file_suffix,file_path from file_tbl;";
	...
	public List<FileHeaderVo> getFileHeadderDetails(Connection connection) {
		log.info("Method: getFileHeadderDetails()");
		List<FileHeaderVo> fileheaderList = new ArrayList<>();
		String query = "select e.company_key,e.company_name,f.file_id from electricity_company_details_tbl e,file_tbl f;";
